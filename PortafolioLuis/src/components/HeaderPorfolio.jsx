      ...
      <>
        <header className="fixed top-0 z-10 flex items-center justify-center w-full mx-auto mt-2">
          <div className="flex justify-center">
            <nav className="animacionScroll flex backdrop-blur-sm sticky top-0 px-3 text-sm font-medium rounded-full text-gray-600 dark:text-gray-200 justify-center items-center">
